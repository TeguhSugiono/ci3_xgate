...
$route['transaksi/scan_cont_in/fetch_table'] = 'transaksi_scan_cont_in/c_scan_cont_in/c_fetch_table';
$route['transaksi/scan_cont_in/savedata'] = 'transaksi_scan_cont_in/c_scan_cont_in/c_savedata';

$route['transaksi/scan_cont_out/fetch_table'] = 'transaksi_scan_cont_out/c_scan_cont_out/c_fetch_table';
$route['transaksi/scan_cont_out/fetch_table_do'] = 'transaksi_scan_cont_out/c_scan_cont_out/c_fetch_table_do';
$route['transaksi/scan_cont_out/savedata'] = 'transaksi_scan_cont_out/c_scan_cont_out/c_savedata';
$route['transaksi/scan_cont_out/getnotrans'] = 'transaksi_scan_cont_out/c_scan_cont_out/c_getnotrans';
...
$route['download/GetResponPLP_Tujuan/printbarcode'] = 'download_GetResponPLP_Tujuan/c_GetResponPLP_Tujuan/c_printbarcode';
...
$route['transaksi/gatein_fcl/exportxls'] = 'transaksi_gatein_fcl/c_gatein_fcl/c_exportxls';
$route['transaksi/gatein_fcl/get_ready_reffnumber'] = 'transaksi_gatein_fcl/c_gatein_fcl/c_get_ready_reffnumber';
...
$route['transaksi/gateout_fcl/exportxls'] = 'transaksi_gateout_fcl/c_gateout_fcl/c_exportxls';
$route['transaksi/gateout_fcl/get_ready_reffnumber'] = 'transaksi_gateout_fcl/c_gateout_fcl/c_get_ready_reffnumber';
$route['transaksi/gateout_fcl/create_sj'] = 'transaksi_gateout_fcl/c_gateout_fcl/c_create_sj';
...
$route['transaksi/gatein_lcl/import_gate_in_lcl'] = 'transaksi_gatein_lcl/c_gatein_lcl/c_import_gate_in_lcl';
$route['transaksi/gatein_lcl/table_data_in'] = 'transaksi_gatein_lcl/c_gatein_lcl/c_table_data_in';
$route['transaksi/gatein_lcl/proses_import_lcl_in'] = 'transaksi_gatein_lcl/c_gatein_lcl/c_proses_import_lcl_in';
$route['transaksi/gatein_lcl/exportxls'] = 'transaksi_gatein_lcl/c_gatein_lcl/c_exportxls';
...
$route['transaksi/gateout_lcl/exportxls'] = 'transaksi_gateout_lcl/c_gateout_lcl/c_exportxls';

$route['batal_plp/batal_container'] = 'batal_plp_batal_container/c_batal_container';
$route['batal_plp/batal_container/table_batal'] = 'batal_plp_batal_container/c_batal_container/c_table_batal';
$route['batal_plp/batal_container/import'] = 'batal_plp_batal_container/c_batal_container/c_import';
$route['batal_plp/batal_container/import_table'] = 'batal_plp_batal_container/c_batal_container/c_import_table';
$route['batal_plp/batal_container/import_table_proses'] = 'batal_plp_batal_container/c_batal_container/c_import_table_proses';
$route['batal_plp/batal_container/edit'] = 'batal_plp_batal_container/c_batal_container/c_edit';
$route['batal_plp/batal_container/update'] = 'batal_plp_batal_container/c_batal_container/c_update';
$route['batal_plp/batal_container/kirimdata'] = 'batal_plp_batal_container/c_batal_container/c_kirimdata';
$route['batal_plp/batal_container/exportbatal'] = 'batal_plp_batal_container/c_batal_container/c_exportbatal';
...
$route['warehouse_transaksi/receiving'] = 'warehouse_transaksi_receiving/c_receiving' ;
$route['warehouse_transaksi/receiving/tbl_whsin_receiving'] = 'warehouse_transaksi_receiving/c_receiving/tbl_whsin_receiving' ;
$route['warehouse_transaksi/receiving/tbl_whsin_receiving_detail'] = 'warehouse_transaksi_receiving/c_receiving/tbl_whsin_receiving_detail' ;
$route['warehouse_transaksi/receiving/refresh_combo'] = 'warehouse_transaksi_receiving/c_receiving/c_refresh_combo' ;
$route['warehouse_transaksi/receiving/exportdata'] = 'warehouse_transaksi_receiving/c_receiving/c_export_data' ;
$route['warehouse_transaksi/receiving/exportbahandle'] = 'warehouse_transaksi_receiving/c_receiving/c_export_bahandle' ;
$route['warehouse_transaksi/receiving/exporttally'] = 'warehouse_transaksi_receiving/c_receiving/c_export_tally' ;
$route['warehouse_transaksi/receiving/formadd'] = 'warehouse_transaksi_receiving/c_receiving/c_formadd' ;

$route['warehouse_transaksi/permohonan'] = 'warehouse_transaksi_permohonan/c_permohonan' ;
$route['warehouse_transaksi/permohonan/tbl_whs_permohonan'] = 'warehouse_transaksi_permohonan/c_permohonan/tbl_whs_permohonan' ;
$route['warehouse_transaksi/permohonan/tbl_whs_permohonan_detail'] = 'warehouse_transaksi_permohonan/c_permohonan/tbl_whs_permohonan_detail' ;
$route['warehouse_transaksi/permohonan/formadd'] = 'warehouse_transaksi_permohonan/c_permohonan/c_formadd' ;
$route['warehouse_transaksi/permohonan/loadalamat'] = 'warehouse_transaksi_permohonan/c_permohonan/c_loadalamat' ;


// $route['warehouse_transaksi/receiving/detail_bl'] = 'warehouse_transaksi_receiving/c_receiving/c_detail_bl' ;

// $route['warehouse_transaksi/receiving/load_data_bl'] = 'warehouse_transaksi_receiving/c_receiving/c_load_data_bl' ;
// $route['warehouse_transaksi/receiving/save'] = 'warehouse_transaksi_receiving/c_receiving/c_save' ;
// $route['warehouse_transaksi/receiving/formedit'] = 'warehouse_transaksi_receiving/c_receiving/c_formedit';
// $route['warehouse_transaksi/receiving/update'] = 'warehouse_transaksi_receiving/c_receiving/c_update';
// $route['warehouse_transaksi/receiving/delete'] = 'warehouse_transaksi_receiving/c_receiving/c_delete';
