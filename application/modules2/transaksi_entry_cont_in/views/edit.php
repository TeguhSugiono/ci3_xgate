                                            ...
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
                                                <div class="form-group row gutters">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <input type="text" class="form-control form-control-sm" id="eir_r_number" name="eir_r_number"  value="<?= $array_search['eir_in']; ?>" readonly>
                                                        <input type="text" class="form-control form-control-sm" id="id_cont_in" name="id_cont_in"  value="<?= $array_search['id_cont_in']; ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>     
                                            <div class="col-xl-12 col-lglg-12 col-md-12 col-sm-12 col-12 margin-input">
