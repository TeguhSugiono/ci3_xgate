...
class C_daily_movement_detail extends CI_Controller {
    ...
    function c_export() {
        ...
        if($bc_code == "" && $cont_movement == "In All"){
            ...
            $query = "  select 'nomor' as 'No',concat(cont_number,' ',dangers) 'Container No' , reff_code 'Size' , seal_number 'Condition', bruto 'Bruto' ,
            ...
            $query = "  SELECT 'nomor' as 'No',concat(cont_number,' ',dangers) 'Container No' , reff_code 'Size',
