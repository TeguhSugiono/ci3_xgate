...
class C_GetResponPLP_Tujuan extends CI_Controller {
    ...
    function c_download(){
        ...
        $this->m_model->updatedata('db_tpsonline','tbl_xml_webservice',array('id_transfer' => $ID),array('id_api' => $id_api));
    ...
    function transfer_gate_in($ID,$cont_date_in,$cont_time_in){
        ...
        $where = array('ACTIVE' => 0,'FLAG_TRANSFER' => 0,'ID' => $ID);
    ...
    function transfer_ops_in($ID,$cont_date_in,$cont_time_in){
        ...
        $where = array('a.ACTIVE' => 0,'a.FLAG_TRANSFER' => 0,'a.ID' => $ID, 'b.ACTIVE' => 0);
