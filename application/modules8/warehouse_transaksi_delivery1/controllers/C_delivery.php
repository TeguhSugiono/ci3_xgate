...
class C_delivery extends CI_Controller {
    ...
    function tbl_whsout_delivery(){
        ...
        $query.= " ,do_no,DATE_FORMAT(tgl_out,'%d-%m-%Y') 'tgl_out',DATE_FORMAT(time_out,'%H:%i') 'jamkeluar', a.vessel_id,vessel_name   " ;
        $query.= " ,a.shipper_id ,shipper_Name,vehicle_no,destination  "  ;
    ...
    function c_load_data_bl(){
        ...
        $sql= " SELECT a.bl_no,a.consignee_id,c.consignee_name ,a.category_id,b.category_name,dd.item_desc,a.item_code, " ;
        ...
        $sql.= " WHERE a.rec_id = '0' AND a.bl_no  = '".$txtNoDo."'  " ;
    ...
    function c_save(){
        ...
        $query = " SELECT * from whs_t_out_check a 
            ...
            where a.rec_id=0 and b.rec_id=0 and b.bl_no = '".$do_no."' " ;
        ...
        $location_id = explode('   idtabel : ', $this->input->post('category_name_input'))[1] ;
