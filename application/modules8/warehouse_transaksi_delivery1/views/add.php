                                            ...
                                            <div class="row gutters">
                                                ...
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="good_gross_weight_input"  name="good_gross_weight_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Good Volume</label>
                                                        <input type="text" class="form-control" id="good_volume_input"  name="good_volume_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage</label>
                                                        <input type="text" class="form-control" id="damage_unit_input"  name="damage_unit_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage GW</label>
                                                        <input type="text" class="form-control" id="damage_gross_weight_input" name="damage_gross_weight_input">
                                                    </div>
                                                </div>
                                                <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        <label for="inputName">Damage Volume</label>
                                                        <input type="text" class="form-control" id="damage_volume_input"  name="damage_volume_input">
                                                    </div>
                                                </div>
