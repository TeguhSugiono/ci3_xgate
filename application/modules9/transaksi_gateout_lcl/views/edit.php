                                ...
                                <div class="card-body">
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lglg-6 col-md-6 col-sm-12 col-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm" id="NM_ANGKUT" name="NM_ANGKUT" 
                                                        value="<?=$array_search['NM_ANGKUT'];?>" readonly>
                                            <input type="text" class="form-control form-control-sm" id="NO_VOY_FLIGHT" name="NO_VOY_FLIGHT" 
